document.addEventListener('DOMContentLoaded', function() {
    ...
    const teacherData = {
        jieyi: {
            name: "潔宜老師",
            code: "6010",
            photo: "teacher_jieyi.png", // 替換成實際照片或通用照片
            message: `親愛的潔宜老師：<br><br>
            謝謝您這幾年來的照顧和教導！還記得剛上小學的時候，我什麼都不懂，是您一點一點耐心地教我們知識，也教我們怎麼當個好孩子。您上課總是很有趣，會用很多好玩的方法讓我們更容易記住東西，下課的時候也像我們的大朋友一樣，聽我們說好多好多話。<br><br>
            雖然有時候我可能會有點調皮，讓您傷腦筋，但您總是笑笑地提醒我。現在我們要畢業了，心裡真的好捨不得您喔！希望您每天都開開心心的，也要好好照顧身體！我們一定會常常回來看您的！<br><br>
            祝您 畢業快樂 (咦？是我們畢業啦！)，總之，就是天天快樂！`
        },
        junxuan: {
            name: "均璇老師",
            code: "5200",
            photo: "teacher_junxuan.png",
            ...
            我還記得有一次，[這裡可以放一個學生可能記得的小事，例如：我數學考不好很難過，您特別找我聊聊天，告訴我下次努力就好]，那時候真的覺得好溫暖。謝謝您不只教我們課本上的東西，還教我們很多做人做事的道理。<br><br>
            雖然要離開小學了，但我永遠不會忘記您的！希望老師以後也一切順利，每天都充滿笑容！我們會想您的！`
        },
        yanan: {
            name: "雅蔓老師",
            code: "2023",
            photo: "teacher_yanan.png",
            message: `最可愛的雅蔓老師：<br><br>
            六年級的生活因為有您，變得特別精彩！謝謝您總是那麼用心地準備每一堂課，讓我們在學習中找到樂趣。您就像陽光一樣，照亮了我們的教室，也溫暖了我們的心。每次看到您的笑容，就覺得心情好好！<br><br>
